    ...
    <template #header >
      ...
      <div class="flex bg-gradient-to-br from-indigo-50 to-indigo-100 justify-center px-60 py-10 ">
        ...
        <div class="bg-gradient-to-br from-indigo-100 to-yellow-100">
          ...
          <section class="container mx-auto my-12 overflow-hidden bg-white rounded-xl shadow-lg bg-primary border border-none mb-12 ">
            <div class="container px-6 py-10">
                <div class="lg:flex lg:items-center">
                    <div class="space-y-12 lg:w-1/2">
                        <div>
                            <h1 class="text-3xl font-semibold text-white capitalize lg:text-4xl dark:text-white">Participez à <br>{{projet.nom}}</h1>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-white capitalize dark:text-white">La simplicité du partage</h1>

                                <p class="mt-3 text-white dark:text-white-300">
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-white capitalize dark:text-white">Soyez acteur d'une révolution</h1>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-white capitalize dark:text-white">Ensemble on va plus loin</h1>
